                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="table-responsive">
                                    ...
                                    <form action="input-aksi.php" method="post"><!--proses mengirim data ke input-aksi.php -->		
                                    <table>
                                        <tr>
                                            <td>Username</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <input type="radio" id="level" name="level" value="pasien" style="margin-left:22px;" >Pasien
                                            </td>					
